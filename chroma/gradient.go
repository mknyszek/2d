...
// Gradient is a Spectrum that interpolates between a sequence of colors.
//
...
// At implements Spectrum.
func (g Gradient) At(x float64) color.Color {
	if g.Stops == nil {
		...
		return blendRGBA(asRGBA(a), asRGBA(b), fr)
	}
